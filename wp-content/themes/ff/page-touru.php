...
?>	
		<main class="main-content">
			...
			<section class="about-section">
				...
				<h1 class="h1 text-center">Политика конфиденциальности</h1>
							...
							<div class="description">
								...
								<ul>
									<li>
										...
										<p>Настоящие Положение о политике конфиденциальности (далее — Политика) является официальным документом ООО «Один процент», расположенного по адресу: 197101, г. Санкт-Петербург, Каменноостровский пр, д. 26-28, лит А, пом 109Н (далее — «Компания»/ «Оператор»), и определяет порядок обработки и защиты информации о физических лицах (далее — Пользователи), пользующихся сервисами, информацией, услугами, программами (в т.ч. программами лояльности) и продуктами интернет-магазина, расположенного на доменном имени https://www.friendsforever.pet (далее — Сайт).</p>
								...
								— адрес электронной почты.
									...
									<li>
										...
										<p>Мы также собираем персональные данные, не являющиеся персональными − данные, не позволяющие прямо ассоциировать их с каким-либо определённым лицом. Мы можем собирать, использовать, передавать и раскрывать информацию, не являющуюся персональной, для любых целей. Ниже приведены примеры информации, не являющейся персональной, которую мы собираем, и как мы можем её использовать: </p>	
								...
								— удалении Оператором информации, размещаемой Пользователем, в случаях, установленных договором купли продажи (оферта); 
								— при отзыве субъектом персональных данных согласия на обработку персональных данных. </p>

								<p>ИДЕНТИФИКАЦИОННЫЕ ФАЙЛЫ (СOOKIES) И ИНЫЕ ТЕХНОЛОГИИ</p> 
								...
								<p>Если вы можете отключить cookies в настройках используемого Вами веб-браузера или мобильного устройства. Следует учесть, что некоторые функции веб-сайта могут стать недоступными после отключения cookies. </p>
								...
								<p>Куки — это небольшие файлы данных, которые сохраняются на Вашем компьютере или устройстве при посещении нашего веб-сайта. С их помощью веб-браузер запоминает информацию, которая позволяет упростить работу с сайтом и сделать его более удобным для каждого пользователя. Информация о том, как и когда Вы посещаете наш сайт, помогает нам улучшить его. Создание файла куки возможно только в том случае, если это разрешено в настройках веб-браузера. </p>

								<p>В любом браузере файлы куки доступны только для того веб-сайта, который является их создателем. Другие веб-сайты не будут иметь доступа к этим файлам. </p>

								<p>На сайте используются куки Яндекс. Метрики и Google Analytics, которые определяют сессию посетителя, идентифицируют уникального посетителя, отслеживают источник трафика и навигацию. Также используются куки для поддержания сеанса связи с пользователем и запуска специальной анимации при первом посещении сайта. </p>

								<p>Наш домен также может включать в себя элементы, которые устанавливают куки от третьих лиц. </p>
							</li>
							<li>

								<p>VI. Защита персональных данных </p>
								...
								<p>ВОПРОСЫ ОТНОСИТЕЛЬНО КОНФИДЕНЦИАЛЬНОСТИ </p>
									...
									<p>Если у вас возникнут вопросы в отношении Политики Конфиденциальности Компании или обработки данных Компанией, Вы можете связаться с нами по электронному адресу: hello@friendsforever.pet</p> 
									</li>

									<li>
										<p>VII. Обращения пользователей </p>
								...
								<p>Запрос, направляемый Пользователем, должен соответствовать требованиям, установленным Правилами подачи обращений в Службу сервиса и поддержки, а именно содержать: 
								...
								<p>Действие Политики не распространяется на действия и интернет-ресурсы третьих лиц. </p>
									</li>
								</ul>
